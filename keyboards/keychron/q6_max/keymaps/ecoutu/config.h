...
// Tapping term: max ms between press and release to count as a tap (not a
// hold). Used by tap-dance and mod-tap keys. Default is 200.
#define TAPPING_TERM 200

// RGB brightness cap (0-255). Limits max brightness to reduce heat and power
// draw.
